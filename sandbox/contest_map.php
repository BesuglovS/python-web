 ...
 * Карта генерируется скриптом build-config-meta.mjs (вместе с THEORY_CONTESTS
 * в courseData.js), поэтому рассинхрон фронтенда и сервера исключён.
 */
function contestIdForLesson(int $lessonNum): ?int
{
    $map = [
// ─── GENERATED: lesson → contest map (build-config-meta.mjs) — не редактировать вручную
        8 => 7,
        10 => 8,
        12 => 10,
        15 => 9,
