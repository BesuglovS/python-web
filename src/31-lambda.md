...
> **💡 Совет:** если логика занимает более одной строки или требует условий с `if/elif/else`, используйте обычную функцию с `def`. Lambda — для коротких, простых выражений.
