...
server {
    ...
    location ~* ^/(build\.js|extract-quizzes\.js|convert-lessons\.js|router\.php|playwright\.config\.js|package\.json|package-lock\.json|\.eleventy\.js|minify\.js|build-highlight\.mjs|ga\.js)$ {
        deny all;
        access_log off;
        log_not_found off;
    }
